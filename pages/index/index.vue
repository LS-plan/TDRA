<template>
	<view class="container">
		...
		<view class="cate-section" >
			<view class="cate-item" @tap="gotoload()">
				<image src="/static/loadpic.png"></image>
				<text>文件下载</text>
			</view>

			<view class="cate-item" @tap="gotoFAQ()">
				<image src="/static/FAQ.png"></image>
				<text>FAQ专区</text>
			</view>

			<view class="cate-item" @tap="gotoXueshi()">
				<image src="/static/daoru.png"></image>
				<text>学时导入预约</text>
			</view>

			<view class="cate-item" @tap="gotoFuzeren()">
				<image src="/static/fucerenpic.png"></image>
				<text>负责人变更</text>
			</view>
		</view>
		...
		<view class="top_head">
			...
			<view class="main">
				...
				<view class="left_title">
					<view class="title_icon"></view>
					<text class="large-title">课程情况统计</text>
				</view>
				<view class="row head_block">
						<view class="flex_1">
						...
						<text class="text-gray">累计课程数量</text>
					...
					<view class="row head_block">
							...
							<text class="text-gray">课程参与率</text>
							<text class="text-black">{{classes.participate}}%</text>
						</view>	
						
						<view class="left_title">
							<view class="title_icon"></view>
							<text class="large-title">热门课程</text>
						</view>	
